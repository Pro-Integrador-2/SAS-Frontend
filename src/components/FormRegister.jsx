...
const validationSchema = yup.object({
    ...
    idNumber: yup
        .number('Enter your Identification number')
...
const FormRegister = ({submitRegister}) => {
  ...
  return (
    <Box
      ...
      textAlign={'center'}
    >
      <Typography variant='h5' mb={2}>Medical Registration Form</Typography>
      ...
      <TextField
        ...
        <DatePicker 
            ...
            renderInput={(params) => (
                ...
                />)}
            format="DD/MM/YYYY"
            slotProps={{ textField: { fullWidth: true, error: formik.touched.birthday && Boolean(formik.errors.birthday),
            helperText:formik.touched.birthday && formik.errors.birthday } }}
            />
